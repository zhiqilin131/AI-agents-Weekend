    ...
    >
      {collapsed ? (
        <div className="flex items-center gap-2 rounded-full border border-purple-200/80 bg-white/95 shadow-lg backdrop-blur px-2 py-1.5">
          <BuddyTooltip content="Drag this persona panel to a comfortable spot on the screen.">
            <button
              type="button"
          ...
          <BuddyTooltip content="Expand persona switcher — create, delete, or change the active test persona.">
            <button
              type="button"
        ...
        <div className="rounded-2xl border border-purple-200/80 bg-white/95 shadow-xl backdrop-blur p-3 space-y-3">
          <div className="flex items-center justify-between gap-2">
            <BuddyTooltip content="Drag the expanded panel by this handle.">
              <button
                type="button"
                onPointerDown={beginDrag}
            ...
            <BuddyTooltip content="Collapse back to the compact chip.">
              <button
                type="button"
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              disabled={busy}
            />
            <BuddyTooltip content="Create a new local test persona id (development / multi-tenant simulation).">
              <button
                type="button"
            ...
            <BuddyTooltip content="Delete the currently selected persona and its stored profile data (asks for confirmation).">
              <button
                type="button"
