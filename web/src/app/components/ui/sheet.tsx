...
const SheetContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof SheetPrimitive.Content> & {
    ...
    /** When true, omit the default corner X — use an explicit header Close that calls onOpenChange. */
    hideClose?: boolean;
  }
>(({ className, children, side = "right", hideClose = false, ...props }, ref) => (
  <SheetPortal>
    ...
    >
      {children}
      {!hideClose ? (
        <SheetPrimitive.Close className="ring-offset-background focus:ring-ring data-[state=open]:bg-secondary pointer-events-auto absolute top-4 right-4 z-[110] inline-flex size-9 items-center justify-center rounded-md opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none">
