...
def option_generator_prompt(
    ...
    return (
        ...
        "- For each option include tradeoff_tags with low|medium|high|unknown per dimension:\n"
        "  time_cost_level, money_cost_level, stress_load_level, workload_level,\n"
        "  upside_potential_level, downside_severity_level, goal_alignment_level.\n"
        "- Use unknown in tradeoff_tags when not inferable from context — do NOT guess.\n"
        "- Set tag_source=llm_tagging and tag_confidence 0.5–0.85.\n"
        "- tradeoff_tags are structured hypotheses for audit, NOT MCDA numeric scores.\n"
